...
async function initializeMilestones() {
  try {
    ...
    const result = await Milestone.insertMany(newMilestones);
    
    console.log(`🎉 Successfully initialized database with ${result.length} milestones!`);
...
console.log('FirstSteps Milestone Initialization Script');
console.log('========================================');
