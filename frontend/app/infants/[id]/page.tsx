  ...
  return (
    <div className="flex-1 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Infant Details</h1>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      <span>
                        ...
                        {selectedInfant.ageInMonths !== undefined && ` (${selectedInfant.ageInMonths} months)`}
                      </span>
                    </div>
                    <div className="flex items-center text-sm text-gray-600">
                      <User className="h-4 w-4 mr-2" />
                      <span className="capitalize">{selectedInfant.gender}</span>
                    </div>
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        {selectedInfant.birthWeight && (
                          <>
                            ...
                            <span>{selectedInfant.birthWeight} kg</span>
                          </>
                        )}
                        {selectedInfant.birthWeight && selectedInfant.birthLength && (
                        ...
                        {selectedInfant.birthLength && (
                          <>
                            ...
                            <span>{selectedInfant.birthLength} cm</span>
                          </>
                        )}
                      </div>
                    )}
              ...
              <div className="mt-6 md:mt-0">
                <div className="flex space-x-3">
                  <Link href={`/infants/${params.id}/edit`}>
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      if (window.confirm(`Are you sure you want to delete ${selectedInfant.name}? This action cannot be undone.`)) {
                        // In a real implementation, you would call the delete API here
                        // For now, we'll just show a message
                        toast.success(`${selectedInfant.name} has been deleted successfully`)
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {selectedInfant.medicalInfo.pediatrician && (
                  <div>
                    <p className="text-sm font-medium text-gray-500">Pediatrician</p>
        ...
        {/* Milestone Tracking - Only content, no tabs */}
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
