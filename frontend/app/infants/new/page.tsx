...
export default function NewInfantPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (result) {
        toast.success('Infant added successfully!')
        router.push(`/dashboard/infants/${result._id}`)
      }
    } catch (err) {
      toast.error('Failed to add infant. Please try again.')
    } finally {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                      placeholder={t('pediatrician_name')}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                      placeholder={t('pediatrician_contact')}
                    />
                  </div>
                </div>
              </div>
